...
@mock.patch('shoptimizer_api.util.attribute_miner._GENDER_OPTIMIZER_CONFIG_FILE_NAME',
            'gender_optimizer_config_{}_test')
@mock.patch('shoptimizer_api.util.attribute_miner._GPC_STRING_TO_ID_MAPPING_CONFIG_FILE_NAME',
